...
public class Metatag {
    ...
    @Expose
    private String twitterAriaText;
    @SerializedName("og:aria-text")
    @Expose
    private String ogAriaText;
    ...
    @SerializedName("google-signin-client-id")
    @Expose
    ...
    @SerializedName("google-signin-scope")
    @Expose
    private String googleSigninScope;
    ...
    public String getTwitterAriaText() {
        return twitterAriaText;
    }

    public void setTwitterAriaText(String twitterAriaText) {
        this.twitterAriaText = twitterAriaText;
    }

    public String getOgAriaText() {
        return ogAriaText;
    }

    public void setOgAriaText(String ogAriaText) {
        this.ogAriaText = ogAriaText;
    }
    ...
    public String getGoogleSigninScope() {
        return googleSigninScope;
    }

    public void setGoogleSigninScope(String googleSigninScope) {
